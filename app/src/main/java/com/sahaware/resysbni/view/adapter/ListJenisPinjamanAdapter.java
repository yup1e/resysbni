...
public class ListJenisPinjamanAdapter extends ArrayAdapter<String>{

    private Context activity;
    private List data;
    public Resources res;
    DataJenisReveral tempValues=null;
    LayoutInflater inflater;

    /*************  CustomAdapter Constructor *****************/
    public ListJenisPinjamanAdapter(
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        tempValues = null;
        tempValues = (DataJenisReveral) data.get(position);
        ...
        nama.setText(tempValues.getNama());
        keterangan.setText(tempValues.getKeterangan());
        id.setText(tempValues.getIDJenis().toString());
