...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, AdapterView.OnItemClickListener {
    ...
    private static final String API_KEY = "AIzaSyAeB32AiYkUH4kva5WizzvAY3j2Yv15O2k";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userLang=bundle.getDouble("userLang");
        ...
        ;
        //autoCompView.setAdapter(new MapsActivityAdapter(this, R.layout.list_item));
    ...
    class MapsActivityAdapter extends ArrayAdapter implements Filterable {
        private ArrayList resultList;

        public MapsActivityAdapter(Context context, int textViewResourceId) {
